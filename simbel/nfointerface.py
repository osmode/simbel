...
here:
https://omarmetwally.blog/2017/12/05/converting-between-private-net-ether-and-real-ether-the-simbel-protocol/ 
...
class NFOInterface(BCInterface):
	...
	# construct points to simbel contract address on blackswan Ethereum network
	# by default
